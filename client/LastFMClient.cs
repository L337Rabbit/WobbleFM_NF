...
namespace com.okitoki.wobblefm.client
{
    public class LastFMClient
    {
        ...
        public string GetToken()
        {
            ...
            LastFMTokenMessage tokenMessage = JsonConvert.DeserializeObject<LastFMTokenMessage>(responseBodyTask.Result);
        ...
        public LastFMSession CreateSession(string token, bool saveSession = true)
        {
            try
            {
                ...
                LastFMSessionMessage sessionMessage = JsonConvert.DeserializeObject<LastFMSessionMessage>(responseBodyTask.Result);
        ...
        public void LoadSession(string path = "lfmSession.json")
        {
            if(File.Exists(path))
            {
                ...
                LastFMSession session = JsonConvert.DeserializeObject<LastFMSession>(sessionJson);
        ...
        public void SaveSession(LastFMSession session, string path = "lfmSession.json")
        {
            try
            {
                ...
                writer.Write(JsonConvert.SerializeObject(session));
                writer.Flush();
                writer.Close();
            }
            catch(Exception e)
